...
FRAME3DD_GO=`go build $CODE_PATH/main.go -o=$CODE_PATH/frame3dd 2>&1 | wc -l`
echo "In file frame3dd summary : $FRAME3DD_GO warnings in go build."
...
FRAME3DD_UNSAFE=`cat $CODE_PATH/main.go | grep unsafe | wc -l`
echo "Amount unsafe package using: $FRAME3DD_UNSAFE"
